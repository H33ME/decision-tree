...
After installing DiagrammeR call; _xgb.plot.multi.trees(creditBoost,feature_names = colnames(creditX),fill=TRUE)_
```{r plot-xgboost-trees}

#use xgb.plot.importance to plot the trees
